...
$colname_currentDistrict = "-1";
if (isset($_GET['id'])) {
  $colname_currentDistrict = $_GET['id'];
}
mysql_select_db($database_SLC, $SLC);
...
<head>
	...
	<meta charset="utf-8">
	<title><?php echo $row_settings['name']; ?> | <?php if ($row_parentDistrict['id'] != "1") { echo $row_parentDistrict['name']." > ";} echo $row_currentDistrict['name']; ?></title>
							...
							<div class="col-sm-12">
						      ...
						      <!-- BREADCRUMBS -->
									<ul class="breadcrumb">
                                        ...
                                        <li><?php echo $row_currentDistrict['name']; ?></li>
									</ul>
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left"><?php echo $row_currentDistrict['name']; ?></h3>
									</div>
